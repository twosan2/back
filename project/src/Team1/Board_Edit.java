...
class Board_Edit extends JFrame{
   ...
   JLabel lblNewLabel_1 = new JLabel("비번");
   				//DS textField_2 -> textField_1 수정함
   JTextField textField_1 = new JTextField();
   JLabel label = new JLabel("이미지");
   				//DS textField_3 -> textField_2 수정함
   ...
   private void display() {
      ...
      //DS setColumns 줄 제거함
      textField_1.setBounds(60, 87, 600, 24);
      mainPanel.add(textField_1);
      
      textField_2.setBounds(60, 50, 600, 24);
   ...
   private void event() {
      ...
      btnNewButton.addActionListener(e->{
    	  ...
    	  bc.allSet(textField.getText(), textField_1.getText(),
    			  	textField_2.getText(),textArea.getText());
